...
const enemyTable = [
    ...
    { name: 'まほうつかい', hp: 13, maxHp: 13, attack: 11, defense: 12, agility: 12, evasion: 1, exp: 4,  gold: 12,  sprite: { x: 44,  y: 103, w: 36, h: 39 }, pattern: ['attack', 'gira', 'gira', 'mahotone'] },
    { name: 'おおさそり',   hp: 20, maxHp: 20, attack: 18, defense: 16, agility: 16, evasion: 1, exp: 6,  gold: 16,  sprite: { x: 93,  y: 146, w: 40, h: 31 } },
    ...
    { name: 'キメラ',       hp: 42, maxHp: 42, attack: 56, defense: 48, agility: 48, evasion: 2, exp: 24, gold: 100, sprite: { x: 45,  y: 346, w: 37, h: 44 }, pattern: ['attack', 'attack', 'hoimi'] },
    { name: 'あくまのきし', hp: 70, maxHp: 70, attack: 94, defense: 82, agility: 82, evasion: 1, exp: 54, gold: 165, sprite: { x: 108, y: 399, w: 48, h: 52 } },
